...
def ik_track(model, data, site_name, target_pos,
    ...
    for i in range(max_iters):
        ...
        # linear system (J @ J^T + damping * I) x = weighted_err for x, and then compute qdot = J^T @ x. This is more stable and efficient than computing the inverse.        weighted_err = np.zeros(6)
